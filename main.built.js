                ...
                i = {
                    ...
                    fetchMapData: function (e) {
                        var t = new n.Deferred,
                            r = n.getJSON("http://map.utoronto.ca/data/map/" + e),
                            i = n.getJSON("http://map.utoronto.ca/data/regions/" + e);
                    ...
                    search: function (e, t) {
                        ...
                        var r = n.getJSON("http://map.utoronto.ca/data/map/" + t + "/search/" + e + "/only_id").done(this.displaySearchResults);
